    ...
    if (self.type == HMSegmentedControlTypeText) {
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
            ...
            if (self.segmentWidthStyle == HMSegmentedControlSegmentWidthStyleFixed) {
                ...
                rectDiv = CGRectMake((self.segmentWidth * idx)-0.5, self.selectionIndicatorHeight*3, 1, self.frame.size.height-(self.selectionIndicatorHeight*6));
                ...
                rectDiv = CGRectMake(xOffset-0.5, self.selectionIndicatorHeight*3, 1, self.frame.size.height-(self.selectionIndicatorHeight*6));
            }
