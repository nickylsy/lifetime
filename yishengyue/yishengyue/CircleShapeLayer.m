...
//    [gradientLayer1 setColors:[NSArray arrayWithObjects:(id)[UIColorFromRGB(0xf0a52b) CGColor],[UIColorFromRGB(0xf95d30) CGColor], nil]];
...
- (CGPathRef)drawPathWithArcCenter {
    ...
    return [UIBezierPath bezierPathWithArcCenter:CGPointMake(position_x, position_y)
                                          radius:position_y*0.9
                                      startAngle:(-M_PI-jiaodu)
                                        endAngle:(jiaodu)
