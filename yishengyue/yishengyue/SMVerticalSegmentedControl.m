...
-(id)initWithCoder:(NSCoder *)aDecoder
{
    if (self=[super initWithCoder:aDecoder]) {
        self.sectionTitles=[NSArray arrayWithObjects:@"热门推荐",@"生态家装",@"智能家居", nil];
        self.textFont=[UIFont fontWithName:@"Helvetica" size:17];
    }
    return self;
}
...
- (void)drawRect:(CGRect)rect
{
    ...
    self.selectionIndicatorBoxLayer.backgroundColor = [UIColor grayColor].CGColor;
    self.selectionIndicatorBoxLayer.borderColor = [UIColor blackColor].CGColor;
